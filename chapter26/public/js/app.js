...
var routes = [{
    path: '/',
    component: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./views/Home\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
}, {
    path: '/about',
    component: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./views/About\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
}];
